...
/*   Updated: 2023/12/20 12:31:17 by jhouyet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_game *game)
{
	...
	mlx_xpm_file_to_image(game->mlx, "assets/images/floor.xpm", &w, &h);
	game->textures->wall = \
	mlx_xpm_file_to_image(game->mlx, "assets/images/wall.xpm", &w, &h);
	game->textures->player = \
	mlx_xpm_file_to_image(game->mlx, "assets/images/player.xpm", &w, &h);
	game->textures->exit = \
	mlx_xpm_file_to_image(game->mlx, "assets/images/exit.xpm", &w, &h);
	game->textures->item = \
	mlx_xpm_file_to_image(game->mlx, "assets/images/collectible.xpm", &w, &h);
